...
skill_enter=Entry(app)
skill_enter.grid(row=3,column=1)
...
def save_data():
    ...
    skill=skill_enter.get()
    skill_enter.delete(0,END)
...
btnClick = Button(app, text = "click", width = 10,command=save_data())
